...
values ('11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888888', 'maquina', 'Galpão de suínos 2017', 240000.00, 0, '2017-03-01', 25);
...
select throws_ok(
  $$insert into public.imobilizados (propriedade_id, unidade_negocio_id, categoria, nome, valor_aquisicao, valor_residual, data_aquisicao, vida_util_anos)
    values ('11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888888', 'maquina', 'Item inválido', 1000.00, 0, '2020-01-01', 0)$$,
